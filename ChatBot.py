#This is a Physical fitness information chat bot.
...
#Get the article
article = Article('https://en.wikipedia.org/wiki/Physical_fitness')
article.download()
article.parse()
article.nlp()
corpus = article.text
...
#start the chat
print('Physical fitness Helpline: I am here to help you. Type exit or bye if you want to close the chat.')
